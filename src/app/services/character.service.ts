...
export class CharacterService {
  ...
  exampleWeapon: equipment = { name: "Dagger", quantity: 2, carried: "Yes", weight: 1, equipType: "Weapon", description: " Category: Simple Melee Weapon, Cost: 2gp, Damage: 1d4 piercing, Properties:Finesse, light, thrown (range 20/60)", equipped: "Yes" };
  exampleArmor: equipment = { equipped: "Yes", name: "Chain Shirt", quantity: 1, carried: "Yes", weight: 20, equipType: "Armor", description: " Type: Medium Armor, Cost: 50 gp, Armor Class: 13, Made of interlocking metal rings, a chain shirt is worn between layers of clothing or leather. This armor offers modest protection to the wearer’s upper body and allows the sound of the rings rubbing against one another to be muffled by outer layers" }
  ...
  exampleGear2: equipment = { name: "Explorer's Pack", quantity: 1, carried: "Yes", weight: 3, equipType: "Gear", equipped: "No", description: " Cost: 10gp, Includes a backpack, a bedroll, a mess kit, a tinderbox, 10 torches, 10 days of rations, and a waterskin. The pack also has 50 feet of hempen rope strapped to the side of it" };
  exampleTool: equipment = { name: "Thieve's Tools", weight: 1, quantity: 1, carried: "Yes", equipType: "Tool", equipped: "No", description: " Cost: 25 gp, This set of tools includes a small file, a set of lock picks, a small mirror mounted on a metal handle, a set of narrow-bladed scissors, and a pair of pliers. Proficiency with these tools lets you add your proficiency bonus to any ability checks you make to disarm traps or open locks" }
  exampleWeapon2: equipment = { name: "Shortbow", weight: 2, quantity: 1, carried: "Yes", equipped: "No", equipType: "Weapon", description: " Category: Simple Ranged, Cost: 25gp, Damage: 1d6 piercing, Properties: Ammunition (range 80/320). two-handed" }
  ...
  exampleMelee: action = { name: "Unarmed Strike", description: "", damage: "1d6 + 2", actionType: "Melee" };
  exampleMelee2: action = { name: "Warhammer", description: "Bludgeoning", damage: "1d10 + 3", actionType: "Melee" };
  exampleRange: action = { name: "Shortbow", description: "Piercing", damage: "1d6", actionType: "Range" };
  exampleMagic: action = { name: "Blade of Avernus (Vorpal)", description: "Slashing", damage: "2d6 + 7", actionType: "Magic Item" };
  exampleActions: action[] = [this.exampleMelee, this.exampleRange, this.exampleMelee2, this.exampleMagic]
...
export interface equipment {
  ...
  carried: "Yes" | "No";
  weight: number;
  equipType: "Armor" | "Weapon" | "Gear" | "Tool"
  equipped: "Yes" | "No";
}
...
export interface action {
  ...
  actionType: "Melee" | "Range" | "Spell" | "Power" | "Special" | "Potion" | "Magic Item";
  damage: string;
}
